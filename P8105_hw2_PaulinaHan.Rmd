...
The `snp_tidy2` data set contains 3 columns and 787 rows. It documents the sum of the closing values of the S&P stock index of associating month from 1950 to 2015 using `close` variable.
